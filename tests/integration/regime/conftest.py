"""Fixtures for M08 regime integration tests — needs a real TimescaleDB.

Mirrors tests/integration/patterns/conftest.py: a session-scoped pg_connection
that skips when TimescaleDB is unreachable, and an autouse _clean_state that
truncates ohlcv_1m before and after each test.
"""
